...
test('official API daily free limit is 10', () => {
  assert.equal(agentEngineConfig.DEFAULT_DAILY_FREE_LIMIT, 10);
});
...
test('daily official API limit is enabled for Chinese UI locales', () => {
...
test('daily official API limit is enabled for non-Chinese UI locales', () => {
